...
<div style={{background:'#f8fafc',borderRadius:10,overflow:'hidden',border:'0.5px solid var(--border)'}}>
<div style={{display:'grid',gridTemplateColumns:'1fr auto',padding:'6px 12px',background:'rgba(79,110,247,0.04)',borderBottom:'0.5px solid var(--border)'}}>
<span style={{fontSize:10,fontWeight:600,color:'var(--text-3)',textTransform:'uppercase'}}>User ID</span>
...
<div key={uid} style={{display:'flex',justifyContent:'space-between',alignItems:'center',padding:'8px 12px',borderBottom:'0.5px solid #f1f5f9'}}>
<div style={{fontSize:11,color:'var(--text-2)',fontFamily:'monospace'}}>{uid}</div>
<span style={{
...
<td>
<div style={{fontSize:12,fontWeight:500}}>{u.memberCount}</div>
